...
func Test_extractTagParams(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			comments: []string{
				"Human comment",
				"+gen:deepcopy=package,register=true",
			},
			expect: &enabledTagValue{
				value:    "package",
				register: true,
		...
		},
		{
			comments: []string{
				"Human comment",
				"+gen:deepcopy=package,register=false",
			},
			expect: &enabledTagValue{
				value:    "package",
				register: false,
...
func Test_extractInterfacesTag(t *testing.T) {
	testCases := []struct {
		...
		{
			comments: []string{
				"+gen:deepcopy:interfaces=k8s.io/kubernetes/runtime.Object",
			},
			expect: []string{
		...
		},
		{
			comments: []string{
				"+gen:deepcopy:interfaces=k8s.io/kubernetes/runtime.Object",
				"+gen:deepcopy:interfaces=k8s.io/kubernetes/runtime.List",
			},
			expect: []string{
				"k8s.io/kubernetes/runtime.Object",
