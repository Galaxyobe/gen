...
//
//	// +gen:deepcopy:interfaces=k8s.io/kubernetes/runtime.Object,k8s.io/kubernetes/runtime.List
//
...
// interfaces.
//
// The deepcopy funcs for interfaces using "+gen:deepcopy:interfaces" use the pointer
...
import (
	...
	"github.com/galaxyobe/gen/cmd/deepcopy-gen/generators"
	"github.com/galaxyobe/gen/pkg/util"
)

// -v 7 -i github.com/galaxyobe/gen/cmd/deepcopy-gen/output_tests/... --trim-path-prefix github.com/galaxyobe/gen/cmd/deepcopy-gen -o .
func main() {
	klog.InitFlags(nil)
